...
<div class="card card-body">
    <div class="row">
      ...
      <div class="col-lg-12 d-flex align-items-center">
        <form class="flex row" method="POST" action="{{route('guru.tugas.store', ['id_jadwal' => $kelas->id_jadwal])}}">
           @csrf
          <div class="form-group col-lg-12">
            <label class="form-label" for="inputJudul">Judul:</label>
            <input type="text" class="form-control" value="{{old('judul')}}" id="inputJudul" name="judul" placeholder="Masukan Judul Tugas">
            @if ($errors->has('judul'))
          ...
          <div class="form-group col-lg-12">
            <label class="form-label" for="konten">Tugas / Konten:</label>
            <textarea class="form-control" placeholder="Masukan tugas" rows="10"  id="konten" name="konten">{{old('konten')}}</textarea>
